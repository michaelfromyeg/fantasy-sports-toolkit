...
This is the swap point. A future `espn` or `yahoo` provider plugin could expose the
same kind of roster/matchup data for other sports, and the `fantasy-manager` skills
